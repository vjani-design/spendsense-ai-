...
import { ChevronLeft, ShoppingCart, Calendar, Tag, Type } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#f8f9fc] dark:bg-slate-950 pb-24">
      ...
      <main className="px-6 -mt-16">
        <form onSubmit={handleAdd} className="space-y-6">
          ...
          <Button type="submit" className="w-full h-16 rounded-full bg-red-500 hover:bg-red-600 text-xl font-bold shadow-[0_8px_25px_rgba(239,68,68,0.25)] transition-all active:scale-95">
            Save Expense
          </Button>
        </form>
      </main>
